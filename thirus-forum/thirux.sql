...
--
-- Host: localhost
-- Generation Time: Jul 22, 2011 at 11:26 PM
...
--
CREATE DATABASE `blogdatabase` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `blogdatabase`;

-- --------------------------------------------------------

--
-- Table structure for table `thiru`
--

CREATE TABLE IF NOT EXISTS `thiru` (
...
--
-- Dumping data for table `thiru`
--

INSERT INTO `thiru` (`id`, `topic`, `content`, `date`, `images`) VALUES
(1, 'sef', 'content=sfdsdfsdf', '2011-07-22', NULL);
...
INSERT INTO `users` (`id`, `username`, `password`, `blogname`, `title`) VALUES
(1, 'x', '018f4d7f06cb8626e1756452581373e05ae41c56', 'thiru', 'fdgxd');
--
-- Database: `dbthirux`
--
CREATE DATABASE `dbthirux` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dbthirux`;
...
CREATE TABLE IF NOT EXISTS `info` (
  ...
  `password` text,
  `unmarried` varchar(15) DEFAULT NULL,
  `18years` varchar(20) DEFAULT NULL,
  `student` varchar(20) DEFAULT NULL,
  `indian` varchar(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `info` (`name`, `sample`, `password`, `unmarried`, `18years`, `student`, `indian`) VALUES
('S g u r u', 'dddda%asd', '*CFD562A40126FD35EA4EB9EC838BAB1AA58A8896', 'no', 'yes', 'yes', 'yes'),
('DAS', 'asddd%asd', '*28DF85F3A74EAC3574573DB4166A69F5C0FEAA4A', 'yes', 'yes', 'no', 'yes'),
('D', 'samas%ass', '*F7BFF5651DFFDD6175EED7D5F481714D3AB4547F', 'no', 'yes', 'yes', 'yes'),
('T', 'asddd%asd', '*9C5685FAAC38B59473E9D55A626F4FA7273D57C4', 'no', 'yes', 'yes', 'yes');
--
-- Database: `forx`
--
CREATE DATABASE `forx` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `forx`;
...
('thiru', '*F24059C44AE7FCD38A595267C522FB133E9F06F1'),
('p', '*7B9EBEED26AA52ED10C0F549FA863F13C39E0209');

-- --------------------------------------------------------

--
-- Table structure for table `xc`
--
...
--
-- Dumping data for table `xc`
--

INSERT INTO `xc` (`username`, `password`) VALUES
('q', '*3FBEFEC33FD8E842761B011670846D73057E67BE');
--
...
(NULL, 'blogdatabase', 'thiru', 'id', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'thiru', 'topic', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'thiru', 'content', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'thiru', 'date', 4, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'thiru', 'images', 5, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'users', 'username', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'users', 'password', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'users', 'blogname', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'blogdatabase', 'users', 'title', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'name', 1, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'sample', 2, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'password', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'unmarried', 4, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', '18years', 5, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'student', 6, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'dbthirux', 'info', 'indian', 7, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'forx', 'info', 'username', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'forx', 'info', 'password', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'forx', 'xc', 'username', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'forx', 'xc', 'password', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
...
(NULL, 'thiru', 'info', 'username', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'info', 'password', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'likex', 'username', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'likex', 'post_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'likex', 'stat', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'post_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'parent_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'username', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'title', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'content', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'time', 6, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'postx', 'date', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'username', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'gender', 2, NULL, 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'name', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'birthday', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'occupation', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'interest', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'location', 7, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'email', 8, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'picture', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'joindate', 10, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'userx', 'last', 11, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
(NULL, 'thiru', 'viewx', 'parent_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'thiru', 'viewx', 'views', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
...
('COM_SHOW_TABLE_STATUS', '97'),
('COM_SHOW_TABLES', '61'),
('COM_SHOW_TRIGGERS', '18'),
...
('QCACHE_FREE_MEMORY', '16700096'),
('QCACHE_HITS', '123'),
('QCACHE_INSERTS', '120'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '109'),
('QCACHE_QUERIES_IN_CACHE', '59'),
('QCACHE_TOTAL_BLOCKS', '130'),
('QUERIES', '1390'),
('QUESTIONS', '1390'),
('RPL_STATUS', 'NULL'),
('SELECT_FULL_JOIN', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '8945'),
('UPTIME_SINCE_FLUSH_STATUS', '8945');
...
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/thiru-TravelMate-5720-slow.log'),
('HAVE_SSL', 'DISABLED'),
('PROFILING', 'OFF'),
...
('GENERAL_LOG_FILE', '/var/lib/mysql/thiru-TravelMate-5720.log'),
('SKIP_NAME_RESOLVE', 'OFF'),
('SSL_CERT', ''),
('SQL_BIG_TABLES', 'OFF'),
('AUTO_INCREMENT_INCREMENT', '1'),
('PID_FILE', '/var/lib/mysql/thiru-TravelMate-5720.pid'),
('TMPDIR', '/tmp'),
...
('HOSTNAME', 'thiru-TravelMate-5720'),
('ERROR_COUNT', '0'),
('LAST_INSERT_ID', '0'),
...
(NULL, 'blogdatabase', 'PRIMARY', NULL, 'blogdatabase', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, NULL, '', '', NULL),
(NULL, 'blogdatabase', 'thiru', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 36, 36, 281474976710655, 1024, 0, '2011-07-22 23:11:54', '2011-07-22 23:12:37', NULL, NULL, '', '', NULL),
(NULL, 'blogdatabase', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 80, 80, 281474976710655, 2048, 0, '2011-07-22 23:11:00', '2011-07-22 23:19:10', NULL, NULL, '', '', NULL),
(NULL, 'dbthirux', 'info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 79, 316, 281474976710655, 1024, 0, '2011-07-06 18:30:08', '2011-07-07 00:31:21', NULL, NULL, '', '', NULL),
(NULL, 'forx', 'info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 60, 120, 281474976710655, 1024, 0, '2011-06-26 12:14:39', '2011-06-26 12:19:51', '2011-06-26 22:26:10', NULL, '', '', NULL),
(NULL, 'forx', 'xc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 52, 52, 281474976710655, 1024, 0, '2011-06-26 12:22:24', '2011-06-26 12:22:51', '2011-06-26 22:26:10', NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-05-25 01:27:52', '2011-05-25 01:27:52', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 123848989752688639, 2048, 0, '2011-05-25 01:27:55', '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-05-25 01:27:53', '2011-05-25 01:27:53', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 452, 197, 89044, 55450570411999231, 16384, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 993, 9, 8937, 2533274790395903, 17408, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 850, 432252, 281474976710655, 20480, 0, '2011-05-25 01:27:20', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2011-05-25 01:27:20', '2011-05-25 01:27:20', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-05-25 01:27:54', '2011-05-25 01:27:54', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-05-25 01:27:54', '2011-05-25 01:27:54', '2011-05-25 01:27:54', NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-05-25 01:27:20', '2011-05-25 01:27:20', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-05-25 01:27:51', '2011-05-25 01:27:51', '2011-05-25 01:27:51', NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 98, 392, 281474976710655, 2048, 0, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, NULL, '', '', NULL),
(NULL, 'thiru', 'info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 416, 281474976710655, 1024, 312, '2011-07-22 17:24:38', '2011-07-22 22:41:39', NULL, NULL, '', '', NULL),
(NULL, 'thiru', 'likex', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 20, 600, 281474976710655, 1024, 560, '2011-07-22 17:52:17', '2011-07-22 22:41:48', NULL, NULL, '', '', NULL),
(NULL, 'thiru', 'postx', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 53, 984, 281474976710655, 1024, 396, '2011-07-22 17:42:38', '2011-07-22 22:43:24', NULL, NULL, '', '', NULL),
(NULL, 'thiru', 'userx', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 112, 516, 281474976710655, 1024, 292, '2011-07-22 17:23:21', '2011-07-22 22:42:49', NULL, NULL, '', '', NULL),
(NULL, 'thiru', 'viewx', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 9, 225, 2533274790395903, 1024, 180, '2011-07-03 14:38:53', '2011-07-22 23:25:47', NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL'),
('InnoDB', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'MySQL AB', 'Default engine as of MySQL 3.23 with great performance', 'GPL'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50154.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL');
...
(239, 'root', 'localhost', 'forx', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'blogdatabase', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'dbthirux', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'forx', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'thiru', 'latin1', 'latin1_swedish_ci', NULL);
...
(NULL, 'blogdatabase', 'users', 0, 'blogdatabase', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 508, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 508, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'mysql', 'user', 0, 'mysql', 'PRIMARY', 2, 'User', 'A', 4, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-07-22 23:26:26', '2011-07-22 23:26:26', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'blogdatabase', 'thiru', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 36, 36, 281474976710655, 1024, 0, NULL, '2011-07-22 23:11:54', '2011-07-22 23:12:37', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'blogdatabase', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 80, 80, 281474976710655, 2048, 0, 2, '2011-07-22 23:11:00', '2011-07-22 23:19:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'dbthirux', 'info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 79, 316, 281474976710655, 1024, 0, NULL, '2011-07-06 18:30:08', '2011-07-07 00:31:21', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'forx', 'info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 60, 120, 281474976710655, 1024, 0, NULL, '2011-06-26 12:14:39', '2011-06-26 12:19:51', '2011-06-26 22:26:10', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'forx', 'xc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 52, 52, 281474976710655, 1024, 0, NULL, '2011-06-26 12:22:24', '2011-06-26 12:22:51', '2011-06-26 22:26:10', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-05-25 01:27:52', '2011-05-25 01:27:52', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 123848989752688639, 2048, 0, NULL, '2011-05-25 01:27:55', '2011-05-25 01:27:55', '2011-05-25 01:27:55', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-05-25 01:27:53', '2011-05-25 01:27:53', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 452, 197, 89044, 55450570411999231, 16384, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 993, 9, 8937, 2533274790395903, 17408, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 850, 432252, 281474976710655, 20480, 0, NULL, '2011-05-25 01:27:20', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2011-05-25 01:27:20', '2011-05-25 01:27:20', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-05-25 01:27:54', '2011-05-25 01:27:54', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-05-25 01:27:54', '2011-05-25 01:27:54', '2011-05-25 01:27:54', 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-05-25 01:27:20', '2011-05-25 01:27:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-05-25 01:27:51', '2011-05-25 01:27:51', '2011-05-25 01:27:51', 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-05-25 01:27:21', '2011-05-25 01:27:21', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 98, 392, 281474976710655, 2048, 0, NULL, '2011-05-25 01:27:55', '2011-05-25 01:27:55', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'thiru', 'info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 416, 281474976710655, 1024, 312, NULL, '2011-07-22 17:24:38', '2011-07-22 22:41:39', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'thiru', 'likex', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 20, 600, 281474976710655, 1024, 560, NULL, '2011-07-22 17:52:17', '2011-07-22 22:41:48', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'thiru', 'postx', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 53, 984, 281474976710655, 1024, 396, NULL, '2011-07-22 17:42:38', '2011-07-22 22:43:24', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'thiru', 'userx', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 112, 516, 281474976710655, 1024, 292, NULL, '2011-07-22 17:23:21', '2011-07-22 22:42:49', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'thiru', 'viewx', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 5, 9, 225, 2533274790395903, 1024, 180, NULL, '2011-07-03 14:38:53', '2011-07-22 23:25:47', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'blogdatabase', 'PRIMARY', 'blogdatabase', 'users', 'PRIMARY KEY'),
...
('''root''@''thiru-TravelMate-5720''', NULL, 'SELECT', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'INSERT', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'UPDATE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'DELETE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'CREATE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'DROP', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'RELOAD', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'SHUTDOWN', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'PROCESS', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'FILE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'REFERENCES', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'INDEX', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'ALTER', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'SHOW DATABASES', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'SUPER', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'LOCK TABLES', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'EXECUTE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'REPLICATION SLAVE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'REPLICATION CLIENT', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'CREATE VIEW', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'SHOW VIEW', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'CREATE ROUTINE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'ALTER ROUTINE', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'CREATE USER', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'EVENT', 'YES'),
('''root''@''thiru-TravelMate-5720''', NULL, 'TRIGGER', 'YES'),
...
(190, 'HELP_VERSION', 9, 'This help information was generated from the MySQL 5.1 Reference Manual\non: 2010-11-28 (revision: 24085)\n\nThis information applies to MySQL 5.1 through 5.1.55.\n', '', ''),
...
('localhost', 'root', '*F24059C44AE7FCD38A595267C522FB133E9F06F1', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('thiru-TravelMate-5720', 'root', '*F24059C44AE7FCD38A595267C522FB133E9F06F1', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('127.0.0.1', 'root', '*F24059C44AE7FCD38A595267C522FB133E9F06F1', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('localhost', 'debian-sys-maint', '*393FC8F05538D19C75192144DE0BB9ECDDB8A581', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
--
-- Database: `thiru`
--
